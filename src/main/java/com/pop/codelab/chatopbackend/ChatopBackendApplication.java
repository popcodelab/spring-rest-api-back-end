...
public class ChatopBackendApplication {
     ...
     * <p></p>
     * The logger is declared as private static final, which means it is a constant and can only be accessed
     * within the ChatopBackendApplication class.
     * It is recommended to use a constant logger instance for performance reasons.
     * <p></p>
     * The LoggerFactory.getLogger() method is used to obtain a logger instance for the specified
     * class (ChatopBackendApplication.class).
     * This method is provided by the SLF4J framework and returns a logger implementation based on the underlying
     * logging framework being used (e.g., Logback, Log4j).
     * <p></p>
     * Example usage:
