 ...
 *
 * <p>The RentalRepository interface specifies the type of entity (Rental) and the type of the primary key (Long)
 ...
 *
 * <p>This interface is used to interact with the database and perform CRUD operations on Rental entities.</p>
 *
